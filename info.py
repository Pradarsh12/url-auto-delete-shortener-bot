...
API_ID = int(environ.get('API_ID', '23161785'))
API_HASH = environ.get('API_HASH', '72e2c9ff7f587a134a46fe99708e3194')
BOT_TOKEN = environ.get('BOT_TOKEN', "6008150873:AAEZMob2xTDpGh02XqmZxLpcq8qFNSLuXyk")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', False))
PICS = (environ.get('PICS', 'https://telegra.ph/file/8435fa63d98e874f40b4b.jpg')).split()

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6010304291').split()]
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', 'd4f68cb1f07f44132f66ea694a4f5ff16febc9fa')
